...
// No logo image in email: inline SVG gets stripped by mobile mail clients, and a
// rasterised PNG carried a white background box. The bold "Stretchy" wordmark
// carries the brand instead and renders identically everywhere.
void S_PATH;
function sLogo(_color: string) {
  return "";
}
// ─── DESIGN SYSTEM ────────────────────────────────────────────────────────────
