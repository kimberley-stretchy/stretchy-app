...
// Black on light schemes, cream on dark. S_PATH kept for reference.
void S_PATH;
function sLogo(color: string) {
  ...
  return `<img src="${APP_URL}/${file}" width="30" height="35" alt="Stretchy" style="display:inline-block;vertical-align:middle;border:0;" />`;
}
// ─── DESIGN SYSTEM ────────────────────────────────────────────────────────────
