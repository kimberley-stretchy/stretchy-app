  ...
  return (
    <main className="min-h-screen bg-cream pb-20">
      ...
      <div className="px-4 max-w-lg mx-auto">
        ...
        {/* Where */}
        <div className="rounded-card p-5 mb-4" style={{ backgroundColor: "#2C8FE0" }}>
          ...
          <div className="flex gap-3 mt-4">
            <button className="flex-1 font-semibold rounded-pill py-3 text-sm transition-all" style={{ backgroundColor: "#1A1A1A", color: "#F5EDE3" }}>
              ↗ Follow along
            </button>
        ...
        <div className="bg-white rounded-card shadow-card p-5 mb-4">
          ...
          <Link href={`/rate/${params.id}`} className="block text-center font-semibold rounded-pill py-4 transition-all hover:brightness-110" style={{ backgroundColor: "#1A1A1A", color: "#F5EDE3", fontSize: "15px" }}>
            Rate {title} →
          </Link>
        </div>
      </div>
