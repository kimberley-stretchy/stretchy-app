...
const SUGGESTIONS: Suggestion[] = [
  { id: "s1", emoji: "⚡", emojiBg: "#FF4D9E",  title: "Sunset HIIT at the viaduct",  type: "HIIT",    votes: 47, matchHost: "Alex K.",  matchStatus: "NOTIFY" },
  { id: "s2", emoji: "Y",  emojiBg: "#A535C7",  title: "Te Atatū Sunday yoga",         type: "YOGA",    votes: 32, matchHost: null,        matchStatus: "NO MATCH" },
  { id: "s3", emoji: "R",  emojiBg: "#E63946",  title: "Run-then-stretch, Ponsonby",   type: "RUN",     votes: 28, matchHost: "Pip C.",    matchStatus: "NOTIFIED" },
  { id: "s4", emoji: "P",  emojiBg: "#2A3FE0",  title: "Lunch pilates in the CBD",     type: "PILATES", votes: 19, matchHost: "Jess M.",   matchStatus: "NOTIFIED" },
  { id: "s5", emoji: "🎵", emojiBg: "#4FB8E0",  title: "Cold plunge + sound bath",     type: "SOUND",   votes: 14, matchHost: null,        matchStatus: "NO MATCH" },
];

const MATCH_STYLE: Record<MatchStatus, { bg: string; text: string }> = {
  "NOTIFY":   { bg: "#2C8FE0", text: "#fff" },
  "NO MATCH": { bg: "#F5EDE3", text: "#9A9590" },
            ...
            return (
              <div key={s.id} className="bg-white rounded-card shadow-card p-4 flex items-center gap-3">
                ...
                <div className="w-10 h-10 rounded-full flex items-center justify-center font-mono font-black text-white flex-shrink-0"
                  style={{ backgroundColor: "#2C8FE0", fontSize: "15px" }}>
                  {s.votes}
                </div>
              </div>
            );
