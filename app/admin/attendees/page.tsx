...
const ATTENDEES = [
  { id: "a1", initial: "M", color: "#902F8A", name: "Marlee Fisher", neighbourhood: "Grey Lynn", sessions: 27, mates: 41, lifetime: 612, vip: true },
  { id: "a2", initial: "K", color: "#0000FF", name: "Kit Petersen",  neighbourhood: "Pt Chev",   sessions: 22, mates: 38, lifetime: 482, vip: false },
  { id: "a3", initial: "A", color: "#E96709", name: "Ari Tipene",    neighbourhood: "Ponsonby",  sessions: 18, mates: 22, lifetime: 410, vip: false },
  { id: "a4", initial: "S", color: "#716F39", name: "Sam Wallace",   neighbourhood: "Herne Bay", sessions: 14, mates: 19, lifetime: 322, vip: false },
  { id: "a5", initial: "J", color: "#0000FF", name: "Jess Mendez",   neighbourhood: "Ponsonby",  sessions: 12, mates: 16, lifetime: 288, vip: false },
  { id: "a6", initial: "O", color: "#29ABE2", name: "Olive Karena",  neighbourhood: "Mt Eden",   sessions: 9,  mates: 11, lifetime: 198, vip: false },
];
      ...
      <div className="px-4 max-w-lg mx-auto space-y-4">
        ...
        <div className="flex gap-2">
          <input value={search} onChange={(e) => setSearch(e.target.value)}
            ...
            className="flex-1 bg-white rounded-card px-4 py-3 text-sm text-ink outline-none focus:ring-2 focus:ring-hot-blue/30 border-2 border-ink" />
            ...
            <div key={a.id} className="flex items-center gap-3 px-4 py-3.5">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {a.vip && (
                    <span className="font-mono text-[9px] font-bold px-1.5 py-0.5 rounded-full" style={{ backgroundColor: "#FCBB16", color: "#14110F" }}>VIP</span>
                  )}
                </div>
