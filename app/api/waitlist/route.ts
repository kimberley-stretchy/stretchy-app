  ...
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto; background: #F5EDE3; padding: 32px; border-radius: 16px;">
      <div style="display: flex; align-items: center; margin-bottom: 28px; gap: 10px;">
        <svg viewBox="0 0 220 257" width="32" height="37" xmlns="http://www.w3.org/2000/svg" style="display:inline-block;vertical-align:middle;"><path d="${S_PATH}" fill="#7A8330"/></svg>
        <span style="font-size: 18px; font-weight: 900; color: #1A1A1A; letter-spacing: -0.02em;">Stretchy</span>
      </div>

      <h1 style="font-size: 30px; font-weight: 900; color: #1A1A1A; margin: 0 0 6px; letter-spacing: -0.02em;">You're on the list. 🌏</h1>
      ...
      <div style="background: #7A8330; border-radius: 14px; padding: 22px; margin-bottom: 20px; color: white;">
      ...
      <div style="background: white; border-radius: 14px; padding: 18px; margin-bottom: 20px;">
        <p style="font-size: 14px; font-weight: 700; color: #1A1A1A; margin: 0 0 8px;">How it works</p>
      ...
      <div style="display: flex; gap: 10px; flex-wrap: wrap; margin-bottom: 8px;">
        <a href="https://www.instagram.com/stretchy.yoga/" style="display: inline-block; background: #1A1A1A; color: #F5EDE3; text-decoration: none; font-size: 12px; font-weight: 700; padding: 10px 18px; border-radius: 8px; letter-spacing: 0.02em;">@stretchy.yoga →</a>
        <a href="https://www.instagram.com/stretchy.social/" style="display: inline-block; background: #1A1A1A; color: #F5EDE3; text-decoration: none; font-size: 12px; font-weight: 700; padding: 10px 18px; border-radius: 8px; letter-spacing: 0.02em;">@stretchy.social →</a>
      </div>
      <p style="font-size: 12px; color: #AAA; margin: 0 0 20px; line-height: 1.5;">
        Follow the journey of how we're building this →
        <a href="https://www.instagram.com/caike.club/" style="color: #7A8330; font-weight: 600; text-decoration: none;">@caike.club</a>
      </p>
